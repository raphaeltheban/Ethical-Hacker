...
iptables -A INPUT -i eth0 -p tcp --dport 53 -j DNS
iptables -A OUTPUT -o eth0 -p tcp --sport 53 -j DNS
...
iptables -A INPUT -i eth0 -p tcp --dport 80 -j HTTP
iptables -A OUTPUT -o eth0 -p tcp --sport 80 -j HTTP
...
iptables -A INPUT -i eth0 -p tcp --dport 443 -j HTTPs
iptables -A OUTPUT -o eth0 -p tcp --sport 443 -j HTTPs
